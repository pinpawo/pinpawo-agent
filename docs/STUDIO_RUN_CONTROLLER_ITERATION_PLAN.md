...
本文描述 `docs/STUDIO_RUN_CONTROLLER_DESIGN.md` 的重做迭代。目标是先清理旧概念,再按可验证的小步重建 Studio runtime。

每个迭代 PR 如产生设计调整,记录到 `docs/STUDIO_RUN_CONTROLLER_PR_DESIGN_ADJUSTMENTS.md`。
...
- `docs/STUDIO_RUN_CONTROLLER_DESIGN.md`
- `docs/STUDIO_RUN_CONTROLLER_ITERATION_PLAN.md`
- `docs/STUDIO_RUN_CONTROLLER_PR_DESIGN_ADJUSTMENTS.md`
