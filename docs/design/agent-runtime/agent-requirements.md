...
详细设计见 [PET_AGENT_TOOLKIT_COMPOSITION_DESIGN.md](toolkit-composition.md)。
...
[Capability / Toolkit V2 契约](../../reference/extensions/capability-toolkit.md#2-capability)。
...
详见
[Capability Artifact Pipeline](../../reference/artifacts/index.md)与
[Capability / Toolkit V2 契约](../../reference/extensions/capability-toolkit.md#7-artifact)。
...
|---|---|---|
| `capability_creator` | `create_capability`, `validate_capability` | capability result artifact |

各 Capability 的共通结构和设计约束见
[Capability / Toolkit V2 契约](../../reference/extensions/capability-toolkit.md)；具体工具
...
- 详细说明见 [PET_AGENT_ORCHESTRATOR_ROUTE_DESIGN.md](orchestrator-routing.md)
...
新增 `packages/pet-agent/`，实现 `runAgent` 和基础 Capability 执行框架。
