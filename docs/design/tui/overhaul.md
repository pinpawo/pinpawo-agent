...
> not current contracts. Use [`LOCAL_AGENT_SESSION_PROJECTION.md`](../../reference/runtime/session-projection.md)
...
> 关联文档：
> - [`LOCAL_AGENT_TUI_ARCHITECTURE.md`](local-agent-tui.md)
> - [`AGENT_TIMELINE_REFACTOR_DESIGN.md`](agent-timeline.md)
> - [`TUI_TEXTAREA_ARCHITECTURE_DESIGN.md`](textarea.md)
