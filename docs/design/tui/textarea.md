...
> 状态：设计依据（过程/意图文档）。本文定义的分层与迁移计划，对应实现已于 2026-06-18 全部合入 main（PR #187 → #193 → #189 → #190）。本文保留"当初为什么这样设计、方向如何迭代"的视角，**不随实现演进改写**；当前 as-built 进度、各 PR 结局与剩余待办见 [`TUI_TEXTAREA_REFACTOR_STATUS.md`](../../history/tui/textarea-refactor-status.md)。
> 日期：2026-06-18
