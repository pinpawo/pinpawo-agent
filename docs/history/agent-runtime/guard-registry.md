...
> Status: deprecated. Superseded by [GUARD_DESIGN.md](../../reference/runtime/guards.md) on 2026-07-02.

The guard design is now defined in [GUARD_DESIGN.md](../../reference/runtime/guards.md).
