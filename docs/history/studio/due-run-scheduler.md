...
> **状态：历史记录。** 本文描述的 due-run scheduler 已随 pull-model
> `StudioOrchestrator` 移除，不是当前 Studio 行为或路线图。请阅读
> [当前 Studio 文档](../../studio/index.md)。
...
- `packages/studio/src/dueRunScheduler.ts`
