...
- completed results cross task boundaries only through an accepted handoff copy.
...
- **Handoff** is the accepted announce copied into main with provenance, after
  which the private lane can be cleared.
- **Completion acknowledgement** is the answer node's stable close after a
  handoff; it is not a second copy of the task deliverable.
