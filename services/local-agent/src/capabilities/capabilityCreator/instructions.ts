export const capabilityCreatorInstructions = [
  ...
  '创建或大改 capability 前，先用 list_dir/view_file_chunk 查看完整示例项目：packages/pet-agent/examples/capabilities/web_research_brief/。如果当前工作目录不是 PinPawo 仓库，先用 glob_search 定位 packages/pet-agent/examples/capabilities。',
