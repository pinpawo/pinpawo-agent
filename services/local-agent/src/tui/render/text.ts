export const TUI_TEXT = {
  ...
  timelineViewUsage: '用法：/timeline snapshot 或 /timeline process',
  timelineViewUnavailable: '当前 TUI 不支持切换 timeline 视图。',
  timelineViewChanged: (label: string) => `已切换 timeline 视图：${label}`,
  timelineProcessUnavailable: '暂无可查看的过程 timeline。',
