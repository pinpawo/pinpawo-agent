...
import { BROWSER_NATIVE_HOST_NAME } from '../../drivers/chromeExtension/protocol';
...
export async function getBrowserExtensionHostStatus(
  ...
  return {
    ...
    bundledExtensionPath: resolve(dirname(paths.nativeHostEntryPath), 'extension'),
    bundledExtensionBuilt: existsSync(resolve(dirname(paths.nativeHostEntryPath), 'extension', 'manifest.json')),
  };
}
